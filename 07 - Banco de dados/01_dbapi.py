...
def criar_tabela(conexao, cursos):
    cursor.execute(
...
# atualizar_registro(conexao, cursor, 'Santos', "santos@gmail.com", 2)
...
# dados = [
#    ('Silva', 'silva@gmail.com'),
#    ('Santos', 'santos@gmail.com'),
#    ('Raffaella', 'raffaella@gmail.com'),
# ]
